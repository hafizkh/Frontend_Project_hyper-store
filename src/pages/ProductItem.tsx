  ...
  return (
    ...
    <h1  style={{ marginTop: '7rem' }} className='d-flex justify-content-center align-items-center container'>Product Detail</h1>
            <div style={{ marginTop: '2rem' }}>
              <Card style={{display:"flex", flexDirection:'inherit', alignItems:'center', width: 'auto' }} className="mx-3 my-3">
                <Card.Img variant="top" src={item.images[0]} style={{ width: '25rem', height:'auto' }} />
